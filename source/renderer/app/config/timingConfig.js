...
export const REPORT_ISSUE_TIME_TRIGGER = isTest
  ...
  : (isIncentivizedTestnet ? 60 : 7) * 60; // 7 minutes / 60 minutes (isIncentivizedTestnet = true) | unit: seconds
...
export const NEWS_POLL_INTERVAL = 1 * 60 * 1000; // 30 minutes | unit: milliseconds
